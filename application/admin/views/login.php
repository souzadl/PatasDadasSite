...
<head>
    ...
    <title>3PPK Content Management System</title>
...
<body>
	<?php //echo $this->CI->session->userdata('lavie_login_usuario'); ?>
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
	            <div class="logo"><img class="img-responsive" src="<?=base_url()?>assets/admin/img/patas-header-logo.png" /></div>
	            
	            <?php if(@$this->session->flashdata('respostaLogin')) : ?>
	            	<div style="margin-top:6%;" class="alert alert-danger"><?=$this->session->flashdata('respostaLogin')?></div>
	            <?php endif; ?>
                ...
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="<?=base_url()?>admin.php/login/entrar/" method="post">
                            <fieldset>
                                ...
                                <button name="submit-login" class="btn btn-lg btn-success btn-block" title="Login">Login</button>
                                
                                <?php //echo $this->encrypt->encode('123'); ?>
                            </fieldset>
                        </form>
                    </div>
                </div>
